	...
	<body>
		...
		<table>
			...
			<tr>
				...
				<td><input type = "text" id = "txtEntryDate" value = "<fmt:formatDate pattern = "dd-MMM-YYYY" value = "<%=date%>"/>" readonly = "readonly" disabled/></td>
			</tr>
			...
			<tr>
				...
				<td><input type = "text" id = "txtLastUpdate" value = "<fmt:formatDate pattern = "dd-MMM-YYYY" value = "<%=date%>"/>" readonly="readonly" disabled/></td>
			</tr>
