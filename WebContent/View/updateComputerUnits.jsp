	...
	<div id="mainContents">
		<div id = "tableDiv" style = "width:1350px; border:1px solid">
			...
			<div id = "unitRecords">
				<c:forEach var="unit" items="${dbRecords}">
					<div id = "unitRecords" class="tableRow" name="rowName">
		...
		<div>
			<table>
				...
				<tr>
					<td><input type = "button" id = "btnUnitAssignment" value = "Unit Assignment"/></td>
					<td><input type = "button" id = "btnOperatingSystemAndSoftwaresInstalled" value = "Operating System and Softwares Installed"/></td>
					<td><input type = "button" id = "btnPeripherals" value = "Peripherals"></td>
